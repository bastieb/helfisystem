...
function Users_view(
    ...
    foreach ($users as $user) {
        ...
        $u['all_shifts_completed'] = icon_bool(User_has_all_shifts_completed($user));
        $u['has_payday'] = icon_bool($user->personalData->has_payday);
        $u['voucher_code'] = $user->personalData->voucher_code;
